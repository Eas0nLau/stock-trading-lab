...
CREATE TABLE `index_market_breadth` (
  `trade_date` int NOT NULL,
...
CREATE TABLE `index_emotion_daily` (
  `trade_date` int NOT NULL,
...
CREATE TABLE `hot_board_emotion_daily` (
  `trade_date` int NOT NULL,
...
CREATE TABLE `broker_listing_history` (
...
CREATE TABLE `ths_board_constituents` (
  `board_code` varchar(16) NOT NULL,
  `stock_code` varchar(16) NOT NULL,
  `board_type` varchar(16) NOT NULL,
  `board_name` varchar(64) NOT NULL,
...
CREATE TABLE `ths_stock_relations` (
  `stock_code` varchar(16) NOT NULL,
  `stock_name` varchar(64) NOT NULL,
