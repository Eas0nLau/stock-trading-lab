...
官方研究入口为 `stock_lab.modules.research`：它提供注入式行情/龙虎榜数据访问、纯回测基础能力、57 个策略的英文标识注册表，以及不会自动连接数据库或网络的 CLI。策略研究文档见 `docs/research-backtesting.md`。`strategy/` 中的中文文件继续作为兼容启动器，并保留中文展示名称。
